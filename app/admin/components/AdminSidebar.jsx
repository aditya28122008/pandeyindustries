  ...
  return (
    <>
      <button
        ...
        type="button"
        className="inline-flex items-center fixed top-0 z-20 p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
        <RxHamburgerMenu className="text-green-500 lg:text-4xl text-2xl" />
      </button>
      <aside
        id="default-sidebar"
        ref={sideBarRef}
        className="fixed top-0 left-0 z-40 md:w-64 w-full h-screen transition-transform -translate-x-full  md:translate-x-0"
        aria-label="Sidenav"
      >
        <button
          onClick={toggleSidebar}
          ...
          aria-controls="default-sidebar"
          type="button"
          className="inline-flex items-center fixed top-0 right-3 z-20 p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        >
          <IoIosCloseCircle className="text-green-500 lg:text-4xl text-2xl" />
        </button>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <AiFillProduct className="w-6 h-6 text-blue-400"/>
